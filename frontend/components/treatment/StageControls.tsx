  ...
  if (!plan) {
    return (
      <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 px-4 py-8 text-center">
        ...
        <p className="text-xs font-medium text-slate-500">No treatment plan generated</p>
        <p className="text-[11px] text-slate-400 mt-1">Generate a plan from the Treatment Plan step</p>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 transition hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed"
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div className="rounded-lg bg-slate-50 border border-slate-200 p-2">
          <p className="text-base font-bold text-slate-800">{plan.totalStages}</p>
          <p className="text-[9px] text-slate-500 uppercase tracking-wide">Aligners</p>
        </div>
        <div className="rounded-lg bg-slate-50 border border-slate-200 p-2">
          <p className="text-base font-bold text-slate-800">{Object.keys(plan.teeth).length}</p>
          <p className="text-[9px] text-slate-500 uppercase tracking-wide">Teeth</p>
        </div>
        <div className="rounded-lg bg-slate-50 border border-slate-200 p-2">
          <p className="text-base font-bold text-slate-800">
            {Math.ceil(plan.totalStages * 10 / 7)}
          </p>
          <p className="text-[9px] text-slate-500 uppercase tracking-wide">Est. weeks</p>
        </div>
      </div>
    </div>
  );
